...
//const azSort = inventory.map(item => item.car_model).sort();
//console.log(azSort);
...
//const newCarYear = inventory
//.map(year => year.car_year)
//.filter(year => year < 2000);
//console.log(newCarYear.length);

// ==== Challenge 6 ====
// A buyer is interested in seeing only BMW and Audi cars within the inventory.  Return an array that only contains BMW and Audi cars.  Once you have populated the BMWAndAudi array, use JSON.stringify() to show the results of the array in the console.

//const highEnd = inventory.filter(
//items => items.car_make === "Audi" || items.car_make === "BMW"
//);
//console.log(JSON.stringify(highEnd, undefined, 2));
